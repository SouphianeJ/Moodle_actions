...
import { listEnrolledStudents } from '@/lib/moodle/studentSubmissionsService';

/**
 * GET /api/actions/student-submissions/enrolled-students
 * 
 * Lists all students enrolled in a course who can submit assignments.
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.error('[API/student-submissions/enrolled-students] Unexpected error:', error);
    return NextResponse.json(
